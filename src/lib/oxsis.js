...
export default class Oxsis {
  ...
  mintNFT = async (address,cid, amount, royalties = 5) => {
    ...
    if (this.web3 !== undefined) {
      ...
      console.log(`https://ipfs.io/ipfs/${cid}`, amount, 5)
      var data = await contractSign.Mint(`https://ipfs.io/ipfs/${cid}`, amount, 5)
